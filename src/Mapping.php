...
trait Mapping
{
     ...
     * @param array<string,mixed|null> $data
     */
    private static function dateTimeAsDateTimeImmutable(
        array $data,
        string $key
    ): DateTimeImmutable {
        if (!isset($data[$key])) {
    ...
    private static function dateTimeImmutableFromDateTimeString(
        string $dateTime
    ): DateTimeImmutable {
        /*
    ...
    private static function dateTimeImmutableAsDateTimeString(
        DateTimeImmutable $dateTimeImmutable
    ): string {
        return $dateTimeImmutable->format(self::$dateTimeFormat);
    }

    private static function removeMicrosecondsPart(
        DateTimeImmutable $dateTimeImmutable
    ): DateTimeImmutable {
